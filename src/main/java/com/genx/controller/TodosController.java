...
import com.genx.dao.TodosDao;
import com.genx.dao.TodosUtils;
import com.genx.model.Product;

@WebServlet("/")
public class TodosController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private TodosDao todoDAO = new TodosUtils();
	...
	private void showNewForm(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("todos/todoForm.jsp");
		dispatcher.forward(request, response);
	}
